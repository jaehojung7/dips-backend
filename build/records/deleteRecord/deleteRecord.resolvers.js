...
var _default = {
  Mutation: {
    deleteRecord: (0, _users.protectedResolver)( /*#__PURE__*/function () {
      var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(_, _ref, _ref2) {
        var id, loggedInUser, existingRecord, deleteRecordExerciseSets, deleteRecordExercises, deleteRecord;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 18:
                ...
                _context.next = 21;
                return _prisma["default"].record["delete"]({
                  where: {
                    id: id
                  }
                });
