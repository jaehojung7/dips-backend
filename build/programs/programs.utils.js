...
exports.processHashtags = exports.defaultPrograms = void 0;

// Parse program description and create hashtag objects
var processHashtags = function processHashtags(description) {
  var hashtags = description.match(/#[ㄱ-ㅎ|ㅏ-ㅣ|가-힣|\w]+/g) || [];
...
exports.defaultPrograms = defaultPrograms;